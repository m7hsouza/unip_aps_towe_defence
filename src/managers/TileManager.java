...
public class TileManager {
  ...
  private void createTiles() {
    ...
    corners.add(BL_WATER_CORNER = new Tile(ImgFix.buildImages(getImages(0, 0, 5, 0)), id++, "BL_Corner"));
    corners.add(TL_WATER_CORNER = new Tile(ImgFix.getBuildRotateImage(getImages(0, 0, 5, 0), 90, 1), id++, "TL_Corner"));
    corners.add(TR_WATER_CORNER = new Tile(ImgFix.getBuildRotateImage(getImages(0, 0, 5, 0), 180, 1), id++, "TR_Corner"));
    corners.add(BR_WATER_CORNER = new Tile(ImgFix.getBuildRotateImage(getImages(0, 0, 5, 0), 270, 1), id++, "BR_Corner"));

    beaches.add(T_WATER = new Tile(ImgFix.buildImages(getImages(0, 0, 6, 0)), id++, "T_Water"));
    beaches.add(R_WATER = new Tile(ImgFix.getBuildRotateImage(getImages(0, 0, 6, 0), 90, 1), id++, "R_Water"));
    beaches.add(B_WATER = new Tile(ImgFix.getBuildRotateImage(getImages(0, 0, 6, 0), 180, 1), id++, "B_Water"));
    beaches.add(L_WATER = new Tile(ImgFix.getBuildRotateImage(getImages(0, 0, 6, 0), 270, 1), id++, "L_Water"));
